...
import { getFirestore, doc, setDoc, collection, getDocs, deleteDoc } from "https://www.gstatic.com/firebasejs/9.6.1/firebase-firestore.js";
...
// LA LISTA DE DATOS CORRECTA Y LIMPIA
const csvData = `
...
async function repararBaseDeDatos() {
    try {
        // --- 1. FASE DE LIMPIEZA ---
        contentDiv.innerHTML = "<p>Iniciando reparación... Fase 1: Limpiando datos...</p>";
        ...
        contentDiv.innerHTML = `<p>Fase 1 completada: Se eliminaron ${borrados} días.</p>`;
        ...
        contentDiv.innerHTML = `
            ...
            <p>Vuelve a GitHub y reemplaza este script por el código final de la app (Misión 21).</p>
        `;
